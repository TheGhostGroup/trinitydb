...
-- 875_mangos_7047_01_characters_character_spell
DELETE FROM `character_spell` WHERE `spell` IN ('28880', 59542, 59543, 59544, 59545, 59547, 59548);
...
-- 875_mangos_7059_01_characters_pet_spell
ALTER TABLE pet_spell
    DROP slot;
    
-- 1026_mangos_7113_01_characters_character_achievement_progress
DELETE FROM character_achievement_progress WHERE counter=0;

-- 1108_mangos_7198_01_characters_characters
...
-- 1135_mangos_7207_03_characters_corpse
ALTER TABLE corpse
  ADD COLUMN `phaseMask` smallint(5) unsigned NOT NULL default '1' AFTER `map`;

-- 1299_mangos_7255_01_characters_characters
