-- Character SQL file: 725_characters.sql
...
-- Character SQL file: 780_characters.sql
...
-- Character SQL file: 927_characters.sql
ALTER TABLE `gm_tickets` CHANGE `closed` `closed` int(10) NOT NULL default '0';

-- Character SQL file: 930_characters.sql
