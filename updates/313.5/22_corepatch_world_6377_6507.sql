-- up to 6518 (DB structure up to 6488 for now)
...
-- missing from world_spell_full.sql
DELETE FROM `spell_learn_spell` WHERE entry IN (5784,13819,23161,23214,34767,34769);
...
-- 5426_8416_world_spell_learn_spell.sql
...
-- missing commands
DELETE FROM `command` WHERE `name` IN ('modify swim','modify speed','modify scale','modify fly','modify bwalk','modify aspeed','account addon','wg','wg enable','wg start','wg status','wg stop','wg switch','wg timer');
